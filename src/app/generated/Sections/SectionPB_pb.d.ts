...
export class SectionFrontObject2 extends jspb.Message {
  getSectionid(): number;
  setSectionid(value: number): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SectionFrontObject2.AsObject;
  static toObject(includeInstance: boolean, msg: SectionFrontObject2): SectionFrontObject2.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SectionFrontObject2, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SectionFrontObject2;
  static deserializeBinaryFromReader(message: SectionFrontObject2, reader: jspb.BinaryReader): SectionFrontObject2;
}

export namespace SectionFrontObject2 {
  export type AsObject = {
    sectionid: number,
    from: number,
    to: number,
...
export class SectionFrontObject extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: SectionFrontObject): SectionFrontObject.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SectionFrontObject, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SectionFrontObject;
  static deserializeBinaryFromReader(message: SectionFrontObject, reader: jspb.BinaryReader): SectionFrontObject;
}
...
export class SectionFrontList extends jspb.Message {
  clearFrontsectionsList(): void;
  getFrontsectionsList(): Array<SectionFrontObject>;
  setFrontsectionsList(value: Array<SectionFrontObject>): void;
  addFrontsections(value?: SectionFrontObject, index?: number): SectionFrontObject;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SectionFrontList.AsObject;
  static toObject(includeInstance: boolean, msg: SectionFrontList): SectionFrontList.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SectionFrontList, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SectionFrontList;
  static deserializeBinaryFromReader(message: SectionFrontList, reader: jspb.BinaryReader): SectionFrontList;
}

export namespace SectionFrontList {
  export type AsObject = {
    frontsectionsList: Array<SectionFrontObject.AsObject>,
  }
}
